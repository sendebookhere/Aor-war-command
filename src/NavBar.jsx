...
export default function NavBar({current}) {
  ...
  return (
    <div style={{marginBottom:"24px"}}>
      {/* HOME — large, always gold */}
      <a href="/" style={{
        display:"block", textAlign:"center",
        padding:"12px 10px 10px",
        background: cur==="/" ? "rgba(255,215,0,0.12)" : "rgba(255,215,0,0.05)",
        border:"1px solid "+(cur==="/" ? "rgba(255,215,0,0.45)" : "rgba(255,215,0,0.18)"),
        ...
        <div style={{fontSize:"13px",color:"#FFD700",fontFamily:"monospace",fontWeight:"bold",letterSpacing:"0.25em"}}>HOME</div>
      </a>
