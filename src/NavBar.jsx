...
function LogoutBtn() {
  const hasSession = !!sessionStorage.getItem("aor_session");
  ...
  return (
    <button onClick={logout} style={{width:"100%",marginTop:"5px",padding:"7px",background:"rgba(255,107,107,0.04)",border:"1px solid rgba(255,107,107,0.12)",borderRadius:"7px",color:"rgba(255,107,107,0.4)",fontSize:"9px",cursor:"pointer",fontFamily:"monospace",letterSpacing:"0.15em"}}>
      CERRAR SESIÓN
    </button>
  );
}
